...
SECRET_KEY = 'django-insecure-5eqmmb1b%de!63y60q#x(7asd0au-opm_ldc)9xq!skg7=k8$='
...
# Static files
STATIC_ROOT = BASE_DIR / 'bh_staticfiles'
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    BASE_DIR , 'static',
]
...
# ===== EMAIL CONFIGURATION =====
EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'  # Prints to console (DEVELOPMENT)
EMAIL_USE_TLS = True
EMAIL_PORT = 587
...
DEFAULT_FROM_EMAIL = 'noreply@blooddonation.com'